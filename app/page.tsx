      ...
      <main>
        <section id="home" className="hero">
          ...
          <div className="hero-copy">
            <div className="hero-hud"><span>◈ SYSTEM ONLINE</span><span>AI / ML CORE</span><span>AUTONOMY: EXPLORING</span></div>
            ...
            <p className="lead">Building production-grade intelligent systems across AI engineering, machine learning, data platforms, cloud and scalable software — while exploring the path from intelligent software to embodied autonomy.</p>
        ...
        <section className="section philosophy reveal">
          <div className="section-label">04 / ENGINEERING PHILOSOPHY</div>
          <div className="philosophy-grid">
            <article><span>01</span><h3>Intelligence</h3><p>Models, agents and knowledge systems that reason over real-world context.</p></article>
            <article><span>02</span><h3>Systems</h3><p>Reliable APIs, data platforms, orchestration and cloud infrastructure behind the intelligence.</p></article>
            <article><span>03</span><h3>Autonomy</h3><p>Exploring adaptive systems where software can perceive, decide, act and continuously improve.</p></article>
          </div>
        </section>

        <section id="skills" className="section skills reveal">
          <div className="section-label">05 / TECHNICAL UNIVERSE</div>
        ...
        <section id="research" className="section research reveal">
          <div className="section-label">07 / RESEARCH & INTERESTS</div>
        ...
        <section className="section credentials reveal">
          <div className="section-label">08 / CERTIFICATIONS & ACHIEVEMENTS</div>
        ...
        <section className="section robotics reveal">
          <div className="robotics-grid">
            <div className="robotics-core"><div className="core-ring"></div><div className="core-dot"></div></div>
            <div><div className="section-label">09 / NEXT FRONTIER</div><h2>From digital intelligence<br/><span>to embodied intelligence.</span></h2>
              <p>Robotics represents the physical extension of intelligent software: perception, reasoning, planning and action moving from screens into the real world.</p>
              <div className="robotics-tags"><span>PERCEPTION</span><span>REASONING</span><span>PLANNING</span><span>AUTONOMY</span></div>
            </div>
          </div>
        </section>
        ...
        <section id="vision" className="section vision reveal">
          ...
          <div className="vision-copy"><div className="section-label">09 / FUTURE VISION</div><h2>Quantum evolution.<br/>Human × AI convergence.<br/>Robotics.</h2>
        ...
        <section id="contact" className="section contact reveal">
          <div className="section-label">11 / CONNECT</div>
